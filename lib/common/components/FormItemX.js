    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FormItemX.__proto__ || Object.getPrototypeOf(FormItemX)).call.apply(_ref, [this].concat(args))), _this), _this.getRules = function () {
      ...
      switch (type) {
        case 'input':
          ...
          return React.createElement(Input, _extends({}, itOpts, { placeholder: placeholder }));
          break;
        case 'select':
          ...
          return React.createElement(Input, _extends({}, stOpts, { placeholder: placeholder }));
          break;
        case 'selectx':
        ...
        case 'number':
          ...
          return React.createElement(InputNumber, _extends({}, inOpts, { placeholder: placeholder }));
          break;
        case 'checkboxx':
          placeholder = '\u8BF7\u9009\u62E9' + _this.props.label;
        ...
        case 'rangepickerx':
          ...
          break;
        case 'datepicker':
          return React.createElement(DatePicker, _extends({}, typeOpts, { placeholder: placeholder }));
          break;
        case 'textarea':
        ...
        case 'treeselect':
          ...
          return React.createElement(TreeSelect, _extends({ showSearch: true, treeNodeFilterProp: 'pinyin' }, treeProps));
          break;
        ...
        default:
          ...
          return React.createElement(Input, _extends({}, ooOpts, { placeholder: placeholder, onKeyUp: function onKeyUp(value) {
