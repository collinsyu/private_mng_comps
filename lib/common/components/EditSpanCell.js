    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        editable ? React.createElement(
          ...
          React.createElement(_Input, { value: value, onChange: this.handleChange, onPressEnter: this.check }),
          React.createElement(_Icon, { type: 'check', className: 'editable-cell-icon-check', onClick: this.check })
        ) : React.createElement(
          'div',
          { className: 'editable-cell-text-wrapper' },
          value || ' ',
          React.createElement(_Icon, { type: 'edit', className: 'editable-cell-icon', onClick: this.edit })
        )
      );
    }
  }]);
