  ...
  _createClass(GlobalHeader, [{
    ...
    value: function render() {
      ...
      var menu = React.createElement(
        ...
        React.createElement(_Menu.Divider, null),
        React.createElement(
          _Menu.Item,
          { key: 'modifyPws' },
        ...
        React.createElement(
          ...
          currentUser.name ? React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(_Avatar, { size: 'small', className: "avatar", src: currentUser.avatar }),
              React.createElement(
                'span',
                { className: "name" },
                currentUser.name
          ...
          ) : React.createElement(_Spin, { size: 'small', style: { marginLeft: 8 } })
        ),
        React.createElement(
          'style',
          null,
