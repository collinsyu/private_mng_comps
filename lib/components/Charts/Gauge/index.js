...
var Gauge = (_dec = autoHeight(), _dec(_class = function (_React$Component) {
  ...
  _createClass(Gauge, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(Coord, { type: 'polar', startAngle: -1.25 * Math.PI, endAngle: 0.25 * Math.PI, radius: 0.8 }),
        React.createElement(Axis, { name: '1', line: null }),
