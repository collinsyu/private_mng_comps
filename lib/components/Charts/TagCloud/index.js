...
var TagCloud = (_dec = autoHeight(), _dec2 = Bind(), _dec3 = Debounce(500), _dec(_class = (_class2 = function (_Component) {
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        dv && React.createElement(
          ...
          React.createElement(Coord, { reflect: 'y' }),
          React.createElement(Geom, { type: 'point', position: 'x*y', color: 'text', shape: 'cloud' })
        )
      );
    }
  }]);
  ...
  return TagCloud;
}(Component), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, 'renderChart', [_dec2, _dec3], {
  enumerable: true,
