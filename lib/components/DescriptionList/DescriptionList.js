...
exports.default = function (_ref) {
  ...
  var clsString = (0, _classnames2.default)("_yhq_descriptionList", styles[layout], className, (_classNames = {}, _defineProperty(_classNames, "_yhq_small", size === 'small'), _defineProperty(_classNames, "_yhq_large", size === 'large'), _classNames));
