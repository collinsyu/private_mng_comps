  ...
  _createClass(NoticeIcon, [{
    ...
    value: function getNotificationBox() {
      ...
      var panes = _react2.default.Children.map(children, function (child) {
        ...
        return _react2.default.createElement(TabPane, { tab: title, key: child.props.title }, _react2.default.createElement(_NoticeList2.default, _extends({}, child.props, {
      ...
      return _react2.default.createElement(_spin2.default, { spinning: loading, delay: 0 }, _react2.default.createElement(_tabs2.default, { className: styles.tabs, onChange: this.onTabChange }, panes));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var trigger = _react2.default.createElement('span', { className: noticeButtonClass }, _react2.default.createElement(_badge2.default, { count: count, className: styles.badge }, _react2.default.createElement(_icon2.default, { type: 'bell', className: styles.icon })));
      if (!notificationBox) {
        return trigger;
      }
      var popoverProps = {};
