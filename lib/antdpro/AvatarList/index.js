...
var AvatarList = function AvatarList(_ref) {
  ...
  return _react2.default.createElement('div', _extends({}, other, { className: styles.avatarList }), _react2.default.createElement('ul', null, ' ', childrenWithProps, ' '));
};
...
var Item = function Item(_ref2) {
  ...
  return _react2.default.createElement('li', { className: cls, onClick: onClick }, tips ? _react2.default.createElement(_tooltip2.default, { title: tips }, _react2.default.createElement(_avatar2.default, { src: src, size: size, style: { cursor: 'pointer' } })) : _react2.default.createElement(_avatar2.default, { src: src, size: size }));
};
