...
exports.default = function (_ref) {
  ...
  return _react2.default.createElement('div', _extends({ className: clsString }, rest), _react2.default.createElement('div', { className: styles.imgBlock }, _react2.default.createElement('div', {
    className: styles.imgEle,
    style: { backgroundImage: 'url(' + (img || _typeConfig2.default[pageType].img) + ')' }
  })), _react2.default.createElement('div', { className: styles.content }, _react2.default.createElement('h1', null, title || _typeConfig2.default[pageType].title), _react2.default.createElement('div', { className: styles.desc }, desc || _typeConfig2.default[pageType].desc), _react2.default.createElement('div', { className: styles.actions }, actions || (0, _react.createElement)(linkElement, {
    to: '/',
    href: '/'
  }, _react2.default.createElement(_button2.default, { type: 'primary' }, '\u8FD4\u56DE\u9996\u9875')))));
};
