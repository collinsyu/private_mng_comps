...
var Description = function Description(_ref) {
  ...
  return _react2.default.createElement(_col2.default, _extends({ className: clsString }, _responsive2.default[column], restProps), term && _react2.default.createElement('div', { className: styles.term }, term), children ? _react2.default.createElement('div', { className: styles.detail }, children) : _react2.default.createElement('div', { className: styles.detail }, initValue));
};
