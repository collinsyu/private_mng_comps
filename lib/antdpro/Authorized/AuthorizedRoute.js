...
var AuthorizedRoute = function (_React$Component) {
  ...
  _createClass(AuthorizedRoute, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_Authorized2.default, {
        authority: authority,
        noMatch: _react2.default.createElement(_router.Route, _extends({}, rest, { render: function render() {
            return _react2.default.createElement(_router.Redirect, { to: { pathname: redirectPath } });
          } }))
      }, _react2.default.createElement(_router.Route, _extends({}, rest, {
