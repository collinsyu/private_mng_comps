...
var EllipsisText = function EllipsisText(_ref) {
  ...
  if (tooltip) {
    return _react2.default.createElement(_tooltip2.default, { title: text }, _react2.default.createElement('span', null, displayText, tail));
  }

  return _react2.default.createElement('span', other, displayText, tail);
};
...
var Ellipsis = function (_Component) {
  ...
  _createClass(Ellipsis, [{
    ...
    value: function render() {
      ...
      if (!lines && !length) {
        return _react2.default.createElement('span', _extends({ className: cls }, restProps), children);
      }
      ...
      if (isSupportLineClamp) {
        ...
        return _react2.default.createElement('div', _extends({ id: id, className: cls }, restProps), _react2.default.createElement('style', null, style), tooltip ? _react2.default.createElement(_tooltip2.default, { title: text }, children) : children);
      }

      var childNode = _react2.default.createElement('span', { ref: this.handleNode }, targetCount > 0 && text.substring(0, targetCount), targetCount > 0 && targetCount < text.length && '...');
      ...
      }, tooltip ? _react2.default.createElement(_tooltip2.default, { title: text }, childNode) : childNode, _react2.default.createElement('div', { className: styles.shadow, ref: this.handleShadowChildren }, children), _react2.default.createElement('div', { className: styles.shadow, ref: this.handleShadow }, _react2.default.createElement('span', null, text))));
    }
  }]);
