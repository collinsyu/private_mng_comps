...
var Login = (_dec = _form2.default.create(), _dec(_class = (_temp2 = _class2 = function (_Component) {
  ...
  _createClass(Login, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: (0, _classnames2.default)(className, styles.main) }, _react2.default.createElement(_form2.default, { onSubmit: this.handleSubmit }, tabs.length ? _react2.default.createElement('div', null, _react2.default.createElement(_tabs2.default, {
        animated: false,
