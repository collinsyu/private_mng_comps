  ...
  _createClass(PageHeader, [{
    ...
    value: function render() {
      ...
      if (breadcrumbList && breadcrumbList.length) {
        breadcrumb = _react2.default.createElement(_breadcrumb2.default, { className: styles.breadcrumb }, breadcrumbList.map(function (item) {
          return _react2.default.createElement(_breadcrumb2.default.Item, { key: item.title }, item.href ? (0, _react.createElement)(linkElement, _defineProperty({}, linkElement === 'a' ? 'href' : 'to', item.href), item.title) : item.title);
        }));
        ...
        var extraBreadcrumbItems = pathSnippets.map(function (_, index) {
          ...
          return currentBreadcrumb.name && !currentBreadcrumb.hideInBreadcrumb ? _react2.default.createElement(_breadcrumb2.default.Item, { key: url }, (0, _react.createElement)(isLinkable ? linkElement : 'span', _defineProperty({}, linkElement === 'a' ? 'href' : 'to', url), currentBreadcrumb.name)) : null;
        });
        var breadcrumbItems = [_react2.default.createElement(_breadcrumb2.default.Item, { key: 'home' }, (0, _react.createElement)(linkElement, _defineProperty({}, linkElement === 'a' ? 'href' : 'to', '/'), '首页'))].concat(extraBreadcrumbItems);
        breadcrumb = _react2.default.createElement(_breadcrumb2.default, { className: styles.breadcrumb }, breadcrumbItems);
      } else {
        breadcrumb = null;
      }
