...
var TagSelect = function (_Component) {
  ...
  _createClass(TagSelect, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: cls, style: style }, _react2.default.createElement(CheckableTag, {
        checked: checkedAll,
        key: 'tag-select-__all__',
        onChange: this.onSelectAll
      }, '\u5168\u90E8'), checkedTags && _react2.default.Children.map(children, function (child) {
        ...
        return child;
      }), expandable && _react2.default.createElement('a', { className: styles.trigger, onClick: this.handleExpand }, expand ? '收起' : '展开', ' ', _react2.default.createElement(_icon2.default, { type: expand ? 'up' : 'down' })));
    }
  }]);
