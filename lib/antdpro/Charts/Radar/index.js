...
var Radar = (_dec = (0, _autoHeight2.default)(), _dec(_class = function (_Component) {
  ...
  _createClass(Radar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: styles.radar, style: { height: height } }, _react2.default.createElement('div', null, title && _react2.default.createElement('h4', null, title), _react2.default.createElement(_bizcharts.Chart, {
        scale: scale,
        height: chartHeight,
        forceFit: forceFit,
        data: data,
      ...
      }, _react2.default.createElement(_bizcharts.Tooltip, null), _react2.default.createElement(_bizcharts.Coord, { type: 'polar' }), _react2.default.createElement(_bizcharts.Axis, {
        name: 'label',
        line: null,
        tickLine: null,
        grid: {
      ...
      }), _react2.default.createElement(_bizcharts.Geom, { type: 'line', position: 'label*value', color: ['name', colors], size: 1 }), _react2.default.createElement(_bizcharts.Geom, {
        type: 'point',
        position: 'label*value',
        color: ['name', colors],
        shape: 'circle',
        size: 3
      })), hasLegend && _react2.default.createElement(_row2.default, { className: styles.legend }, legendData.map(function (item, i) {
        return _react2.default.createElement(_col2.default, {
          span: 24 / legendData.length,
          key: item.name,
          onClick: function onClick() {
            return _this2.handleLegendClick(item, i);
          }
        }, _react2.default.createElement('div', { className: styles.legendItem }, _react2.default.createElement('p', null, _react2.default.createElement('span', {
          className: styles.dot,
          style: { backgroundColor: !item.checked ? '#aaa' : item.color }
        }), _react2.default.createElement('span', null, item.name)), _react2.default.createElement('h6', null, item.value)));
      }))));
    }
  }]);
