...
var TimelineChart = (_dec = (0, _autoHeight2.default)(), _dec(_class = function (_React$Component) {
  ...
  _createClass(TimelineChart, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: styles.timelineChart, style: { height: height + 30 } }, _react2.default.createElement('div', null, title && _react2.default.createElement('h4', null, title), _react2.default.createElement(_bizcharts.Chart, { height: height, padding: padding, data: dv, scale: cols, forceFit: true }, _react2.default.createElement(_bizcharts.Axis, { name: 'x' }), _react2.default.createElement(_bizcharts.Tooltip, null), _react2.default.createElement(_bizcharts.Legend, { name: 'key', position: 'top' }), _react2.default.createElement(_bizcharts.Geom, { type: 'line', position: 'x*value', size: borderWidth, color: 'key' })), _react2.default.createElement('div', { style: { marginRight: -20 } }, _react2.default.createElement(SliderGen, null))));
    }
  }]);
