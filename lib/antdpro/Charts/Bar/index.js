...
var Bar = (_dec = (0, _autoHeight2.default)(), _dec2 = (0, _bind2.default)(), _dec3 = (0, _debounce2.default)(400), _dec(_class = (_class2 = function (_Component) {
  ...
  _createClass(Bar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: styles.chart, style: { height: height }, ref: this.handleRoot }, _react2.default.createElement('div', { ref: this.handleRef }, title && _react2.default.createElement('h4', { style: { marginBottom: 20 } }, title), _react2.default.createElement(_bizcharts.Chart, {
        scale: scale,
      ...
      }), _react2.default.createElement(_bizcharts.Axis, { name: 'y', min: 0 }), _react2.default.createElement(_bizcharts.Tooltip, { showTitle: false, crosshairs: false }), _react2.default.createElement(_bizcharts.Geom, { type: 'interval', position: 'x*y', color: color, tooltip: tooltip }))));
    }
  }]);
