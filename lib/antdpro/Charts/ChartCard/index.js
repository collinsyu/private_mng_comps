...
var ChartCard = function ChartCard(_ref) {
  ...
  var content = _react2.default.createElement('div', { className: styles.chartCard }, _react2.default.createElement('div', {
    className: (0, _classnames2.default)(styles.chartTop, _defineProperty({}, styles.chartTopMargin, !children && !footer))
  }, _react2.default.createElement('div', { className: styles.avatar }, avatar), _react2.default.createElement('div', { className: styles.metaWrap }, _react2.default.createElement('div', { className: styles.meta }, _react2.default.createElement('span', { className: styles.title }, title), _react2.default.createElement('span', { className: styles.action }, action)),

  // eslint-disable-next-line
  total !== undefined && _react2.default.createElement('div', { className: styles.total, dangerouslySetInnerHTML: { __html: total } }))), children && _react2.default.createElement('div', { className: styles.content, style: { height: contentHeight || 'auto' } }, _react2.default.createElement('div', { className: contentHeight && styles.contentFixed }, children)), footer && _react2.default.createElement('div', { className: (0, _classnames2.default)(styles.footer, _defineProperty({}, styles.footerMargin, !children)) }, footer));

  return _react2.default.createElement(_card2.default, _extends({
    bodyStyle: { padding: '20px 24px 8px 24px' }
  }, rest), _react2.default.createElement(_spin2.default, { spinning: loading, wrapperClassName: styles.spin }, content));
};
