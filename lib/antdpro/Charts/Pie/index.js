...
var Pie = (_dec = (0, _autoHeight2.default)(), _dec2 = (0, _bind2.default)(), _dec3 = (0, _debounce2.default)(300), _dec(_class = (_class2 = function (_Component) {
  ...
  _createClass(Pie, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { ref: this.handleRoot, className: pieClassName, style: style }, _react2.default.createElement(_reactFittext2.default, { maxFontSize: 25 }, _react2.default.createElement('div', { className: styles.chart }, _react2.default.createElement(_bizcharts.Chart, {
        scale: scale,
        height: height,
        forceFit: forceFit,
        data: dv,
      ...
      }, !!tooltip && _react2.default.createElement(_bizcharts.Tooltip, { showTitle: false }), _react2.default.createElement(_bizcharts.Coord, { type: 'theta', innerRadius: inner }), _react2.default.createElement(_bizcharts.Geom, {
        ...
        selected: selected
      })), (subTitle || total) && _react2.default.createElement('div', { className: styles.total }, subTitle && _react2.default.createElement('h4', { className: 'pie-sub-title' }, subTitle), total && _react2.default.createElement('div', { className: 'pie-stat', dangerouslySetInnerHTML: { __html: total } })))), hasLegend && _react2.default.createElement('ul', { className: styles.legend }, legendData.map(function (item, i) {
        return _react2.default.createElement('li', { key: item.x, onClick: function onClick() {
            return _this2.handleLegendClick(item, i);
          } }, _react2.default.createElement('span', {
          className: styles.dot,
          style: { backgroundColor: !item.checked ? '#aaa' : item.color }
        }), _react2.default.createElement('span', { className: styles.legendTitle }, item.x), _react2.default.createElement(_divider2.default, { type: 'vertical' }), _react2.default.createElement('span', { className: styles.percent }, (item.percent * 100).toFixed(2) + '%'), _react2.default.createElement('span', {
