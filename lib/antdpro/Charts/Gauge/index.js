...
var Gauge = (_dec = (0, _autoHeight2.default)(), _dec(_class = function (_React$Component) {
  ...
  _createClass(Gauge, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_bizcharts.Chart, { height: height, data: data, scale: cols, padding: [-16, 0, 16, 0], forceFit: forceFit }, _react2.default.createElement(_bizcharts.Coord, { type: 'polar', startAngle: -1.25 * Math.PI, endAngle: 0.25 * Math.PI, radius: 0.8 }), _react2.default.createElement(_bizcharts.Axis, { name: '1', line: null }), _react2.default.createElement(_bizcharts.Axis, {
        line: null,
        tickLine: null,
        subTickLine: null,
        name: 'value',
      ...
      }), _react2.default.createElement(_bizcharts.Guide, null, _react2.default.createElement(Line, {
        start: [3, 0.905],
        end: [3, 0.85],
        lineStyle: {
          stroke: color,
