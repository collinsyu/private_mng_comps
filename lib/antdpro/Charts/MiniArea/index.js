...
var MiniArea = (_dec = (0, _autoHeight2.default)(), _dec(_class = function (_React$Component) {
  ...
  _createClass(MiniArea, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: styles.miniChart, style: { height: height } }, _react2.default.createElement('div', { className: styles.chartContent }, height > 0 && _react2.default.createElement(_bizcharts.Chart, {
        animate: animate,
        scale: scaleProps,
        height: chartHeight,
        forceFit: forceFit,
        ...
        tickLine: false,
        grid: false
      }, xAxis)), _react2.default.createElement(_bizcharts.Axis, _extends({
        key: 'axis-y',
        name: 'y',
        label: false,
        line: false,
        tickLine: false,
        grid: false
      }, yAxis)), _react2.default.createElement(_bizcharts.Tooltip, { showTitle: false, crosshairs: false }), _react2.default.createElement(_bizcharts.Geom, {
        type: 'area',
        position: 'x*y',
        color: color,
        tooltip: tooltip,
