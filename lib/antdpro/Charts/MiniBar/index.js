...
var MiniBar = (_dec = (0, _autoHeight2.default)(), _dec(_class = function (_React$Component) {
  ...
  _createClass(MiniBar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: styles.miniChart, style: { height: height } }, _react2.default.createElement('div', { className: styles.chartContent }, _react2.default.createElement(_bizcharts.Chart, {
        scale: scale,
        height: chartHeight,
        forceFit: forceFit,
        data: data,
        padding: padding
      }, _react2.default.createElement(_bizcharts.Tooltip, { showTitle: false, crosshairs: false }), _react2.default.createElement(_bizcharts.Geom, { type: 'interval', position: 'x*y', color: color, tooltip: tooltip }))));
    }
  }]);
