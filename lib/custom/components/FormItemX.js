...
var _index = require('./RangePickerY/index.js');
...
var _UploadImageXForm = require('./UploadImageXForm');

var _UploadImageXForm2 = _interopRequireDefault(_UploadImageXForm);
...
var FormItemX = function (_Component) {
  ...
  function FormItemX() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FormItemX.__proto__ || Object.getPrototypeOf(FormItemX)).call.apply(_ref, [this].concat(args))), _this), _this.getRules = function () {
    ...
    }, _this.transformRangePickerY = function (props) {
      // const obj2 = {...obj1}; 属于对象浅拷贝
      var opts = _extends({}, props.typeOpts);
      if (_this.props.search) {
        opts = _extends({}, props.typeOpts, { style: { width: 210 } });
      }
      return _react2.default.createElement(_index2.default, _extends({}, opts, { onChange: function onChange(value) {
          if (props.onChange) {
            if (_this.props.start) {
              props.onChange(_this.props.start, value[0].format("YYYY-MM-DD"));
            }
            if (_this.props.end) {
              props.onChange(_this.props.end, value[1].format("YYYY-MM-DD"));
            }
      ...
      switch (type) {
        ...
        case 'rangepickery':
          return _this.transformRangePickerY(_this.props);
        ...
        case 'uploadimagex':
          ...
          return _react2.default.createElement(_UploadImageXForm2.default, uiOpts);
      ...
      if (type === 'rangepickery') {
        var _rangePickerData = [];
        _rangePickerData.push((0, _moment2.default)());
        _rangePickerData.push((0, _moment2.default)());

        if (formItem) {
          if (formItem[start] && formItem[end]) {
            _rangePickerData.push((0, _moment2.default)(formItem[start], 'YYYY-MM-DD'));
            _rangePickerData.push((0, _moment2.default)(formItem[end], 'YYYY-MM-DD'));
          }
        }

        initValue = _rangePickerData;
      }
      if (type === 'datepicker') {
        if (formItem[name]) {
          try {
  ...
  _createClass(FormItemX, [{
    ...
    value: function render() {
      ...
      // let display = true;
      var display = (0, _tool.getAuthFormItem)(this.props.name, this.props.useName);
      if (display) {
      ...
      if (this.props.start) {
        this.props.getFieldDecorator(this.props.start, { initialValue: (0, _moment2.default)().format("YYYY-MM-DD") });
      }
      if (this.props.end) {
        this.props.getFieldDecorator(this.props.end, { initialValue: (0, _moment2.default)().format("YYYY-MM-DD") });
      }
