    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FormItemX.__proto__ || Object.getPrototypeOf(FormItemX)).call.apply(_ref, [this].concat(args))), _this), _this.getRules = function () {
      ...
      switch (type) {
        ...
        case 'treeselect':
          ...
          var treeProps = _extends({}, _this.props.typeOpts, {
            dropdownStyle: { maxHeight: 400, overflow: 'auto' },
            treeData: treeData,
            allowClear: true,
            placeholder: placeholder
          }, _this.props.treeProps);
          return _react2.default.createElement(_treeSelect2.default, _extends({ style: { minHeight: 120 }, showSearch: true, treeNodeFilterProp: 'pinyin' }, treeProps, { onChange: function onChange(value) {
              return _this.props.onChange && _this.props.onChange(_this.props.name, value);
            } }));
