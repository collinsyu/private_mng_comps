  ...
  _createClass(Viewer, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          _props$metaInfo = _props.metaInfo,
          metaInfo = _props$metaInfo === undefined ? {} : _props$metaInfo;
            ...
            _React2.default.createElement(
              ...
              _React2.default.createElement(
                ...
                _React2.default.createElement(
                  ...
                  _React2.default.createElement(
                    _tooltip2.default,
                    { placement: 'top', title: Moment(new Date(metaInfo ? metaInfo.updateAt : "")).format('YYYY-MM-DD HH:mm:ss') },
                    _React2.default.createElement(
                      'span',
                      { className: 'item-text' },
                      Moment(new Date(metaInfo ? metaInfo.updateAt : "")).locale('en').fromNow()
                    )
                  )
                )
              ),
