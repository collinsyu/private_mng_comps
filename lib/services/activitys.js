    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt('return', request('activitys?' + qs.stringify(params)));
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt('return', request('activitys', {
              method: 'post',
              headers: {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return _context3.abrupt('return', request('activitys/new?' + qs.stringify(params)));

          case 4:
            return _context3.abrupt('return', request('activitys/new'));
...
export var doLottery = function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(params) {
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            return _context4.abrupt('return', request('activitys/doLottery?' + qs.stringify(params)));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return _context5.abrupt('return', request('activitys/' + id));
    ...
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            id = params.currentItem.id;
            return _context6.abrupt('return', request('activitys/' + id + '/edit'));
...
export var updateBatch = function () {
  ...
  return function updateBatch(_x9) {
