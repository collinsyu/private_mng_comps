    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt('return', request('bigusers?' + qs.stringify(params)));
    ...
    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt('return', request('bigusers', {
              method: 'post',
              headers: {
    ...
    return _regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            return _context3.abrupt('return', request('bigusers/new'));
    ...
    return _regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            id = params.id;
            return _context4.abrupt('return', request('bigusers/' + id));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return _context5.abrupt('return', request('bigusers/' + id + '/edit'));
    ...
    return _regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            return _context8.abrupt('return', request('bigusers/password', {
              method: 'PATCH',
              headers: {
                "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8"
              },
