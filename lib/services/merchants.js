    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt('return', request('rolemerchants?' + qs.stringify(params)));
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt('return', request('rolemerchants', {
              method: 'post',
              headers: {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            return _context3.abrupt('return', request('rolemerchants/app', {
              method: 'post',
              headers: {
                "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8"
              },
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return _context4.abrupt('return', request('rolemerchants/new?' + qs.stringify(data)));

          case 5:
            return _context4.abrupt('return', request('rolemerchants/new'));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return _context5.abrupt('return', request('rolemerchants/' + id));
...
export var edit = function () {
    ...
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            id = params.currentItem.id;
            return _context6.abrupt('return', request('rolemerchants/' + id + '/edit'));
  ...
  return function edit(_x6) {
    return _ref6.apply(this, arguments);
  };
}();
export var editapp = function () {
    ...
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            id = params.currentItem.id;
            return _context7.abrupt('return', request('rolemerchants/app/' + id + '/edit'));
...
export var updateApp = function () {
    ...
    return regeneratorRuntime.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            url = 'rolemerchants/app/' + params.id;
            return _context10.abrupt('return', request(url, {
              method: 'PATCH',
              headers: {
                "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8"
              },
  ...
  return function updateApp(_x10) {
    return _ref10.apply(this, arguments);
  };
}();

export var recharge = function () {
    ...
    return regeneratorRuntime.wrap(function _callee11$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            url = 'rolemerchants/' + params.id + '/recharge';
            return _context11.abrupt('return', request(url, {
              method: 'PATCH',
              headers: {
                "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8"
              },
